  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="span9">
        ...
        <div class="mensagem-sucesso" display="none">
          <h4>Seu anúncio foi salvo com sucesso</h4>
          <p>Em alguns instantes voce poderá visualiza-lo nos resultados de busca.</p>
        </div>
